<template>
  <div>
    ...
    <section class="page-header">
      <div class="container">
        <div class="page-wrapper">
          <article>
            <h1 class="site-title">Order Now</h1>
          </article>
        </div>
      </div>
    </section>
    ...
    <div class="wrapper">
      <section class="order-now follow">
        <div class="container">
          <h3 class="section-title"><span>Make</span><b>Order</b></h3>
          <p class="text center">
            If you want to place order please fill the form below and select the
          ...
          <section class="contact">
            <div class="container">
              <div class="contact-box">
                <div>
                  <p class="header-contact"><b>Order Form </b></p>
                </div>

                <p class="header-desc">
                  If you want to place order please fill the form below and
                  ...
                  <div class="contact-form">
                    <form action="#" method="post">
                      <div class="column">
                        ...
                        <div class="box-column">
                          <div class="box">
                            <label for="the-name">Choose Product</label>
                          </div>
                          <select
                            class="form-control product-option"
                            id="product"
                          >
                            <option class="product-option">HDPE PIPES</option>
                            <option class="product-option">Product 2</option>
                            <option class="product-option">Product 3</option>
                            <option class="product-option">Product 4</option>
                            <option class="product-option">Product 5</option>
                          </select>
                        </div>
                        <div class="box-column">
                          <div class="box">
                            <label for="the-name">Choose Product Type</label>
                          </div>
                          <select
                            class="form-control product-option"
                            id="product"
                          >
                            <option class="product-option">OD 20</option>
                            <option class="product-option">OD 25</option>
                            <option class="product-option">OD 32</option>
                            <option class="product-option">OD 40</option>
                            <option class="product-option">OD 50</option>
                            <option class="product-option">OD 63</option>
                            <option class="product-option">OD 75</option>
                            <option class="product-option">OD 90</option>
                            <option class="product-option">OD 110</option>
                            <option class="product-option">OD 125</option>
                            <option class="product-option">OD 160</option>
                            <option class="product-option">13 mm</option>
                            <option class="product-option">16 mm</option>
                            <option class="product-option">19 mm</option>
                            <option class="product-option">21 mm</option>
                            <option class="product-option">25 mm</option>
                            <option class="product-option">32 mm</option>
                            <option class="product-option">40 mm</option>
                          </select>
                        </div>
                        <div class="box-column">
                          <div class="box">
                            <label for="the-name">Quantity</label>
                          </div>
                          <input type="text" name="name" id="the-name" />
                        </div>
                      </div>
